...
가로질러 하나의 결과물로 끝난다. **▶ 화면을 클릭하면 영상이 재생됩니다.**

|  |  |  |
|:---:|:---:|:---:|
| [![미팅 전날 준비](docs/videos/thumbs/demo_meeting_prep.jpg)](https://github.com/asj000221-debug/moco-ai-coworker/blob/main/docs/videos/demo_meeting_prep.mp4) | [![발표자료 제작](docs/videos/thumbs/demo_slide_deck.jpg)](https://github.com/asj000221-debug/moco-ai-coworker/blob/main/docs/videos/demo_slide_deck.mp4) | [![스레드 문서화](docs/videos/thumbs/demo_thread_to_doc.jpg)](https://github.com/asj000221-debug/moco-ai-coworker/blob/main/docs/videos/demo_thread_to_doc.mp4) |
| **미팅 전날 준비**<br/>캘린더 확인 · 아젠다 초안 · Slack DM | **발표자료 제작**<br/>PPT 생성 · Google Drive 저장 | **스레드 → 문서화**<br/>의사결정을 Google Docs로 정리 |
| [![스프린트 보고서](docs/videos/thumbs/demo_sprint_report.jpg)](https://github.com/asj000221-debug/moco-ai-coworker/blob/main/docs/videos/demo_sprint_report.mp4) | [![신규 팀원 온보딩](docs/videos/thumbs/demo_onboarding.jpg)](https://github.com/asj000221-debug/moco-ai-coworker/blob/main/docs/videos/demo_onboarding.mp4) | [![주간 브리핑](docs/videos/thumbs/demo_weekly_briefing.jpg)](https://github.com/asj000221-debug/moco-ai-coworker/blob/main/docs/videos/demo_weekly_briefing.mp4) |
| **스프린트 마감 보고서**<br/>Google Docs 리포트 자동 작성 | **신규 팀원 온보딩**<br/>Docs 생성 · 캘린더 등록 · 환영 Gmail | **주간 브리핑**<br/>Drive · 캘린더 · ClickUp · Gmail 종합 → Slack |
